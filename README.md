...
本文只做angular前端架构入门级别的介绍，关于文中提到的一些具体技术细节，可以查看我写的angular系列文章http://www.cnblogs.com/lvdabao/tag/AngularJs/
这个示例项目我已开源到github（https://github.com/Double-Lv/QuestionMaker），目前已经实现了基本功能。后续我会扩展更多的功能，到时候也必然会涉及到更多的技术问题，angular进行前端架构的路才刚刚开始。
